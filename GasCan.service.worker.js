...
/** @type {string} */
const CACHE_VERSION = '1768938865|1907849941';
/** @type {string} */
const CACHE_PREFIX = 'GasCan0.1-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'GasCan.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["GasCan.html","GasCan.js","GasCan.offline.html","GasCan.icon.png","GasCan.apple-touch-icon.png","GasCan.audio.worklet.js","GasCan.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["GasCan.wasm","GasCan.pck"];
